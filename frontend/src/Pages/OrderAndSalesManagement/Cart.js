...
const Cart = () => {
  ...
  const addCoupon = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("http://localhost:5000/coupon/valid-coupon", {
        couponCode: coupon,
      });
      if (res.data.coupon) {
      ...
      <>
        ...
        <section className="bg-black py-8 antialiased md:py-16">
          <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <h2 className="text-xl font-semibold text-orange-600 sm:text-2xl uppercase">
              Shopping Cart
            </h2>
            <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
              <div>
                {cart.length > 0 ? (
                  cart.map((product) => (
                    <div className="mx-auto w-[800px] flex-none mt-5" key={product.id}>
                      <div className="space-y-6">
                        <div className="rounded-lg border border-orange-800 bg-stone-900 p-4 shadow-sm">
                          <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                            ...
                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                              <div className="text-base font-medium text-white hover:underline">
                                {product.name}
                              </div>
              ...
              <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (!user) {
                        toast.error("You need to login to proceed to checkout");
                    ...
                    <button
                      ...
                      className={`flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium ${
                        cart.length === 0
                          ...
                          : "bg-primary-700 text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300"
                      }`}
